...
class CategorieController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('categorie_show', array('idCat' => $categorie->getIdcat()));
        }
     ...
     *
     * @Route("/{idCat}", name="categorie_show")
     * @Method("GET")
     */
     ...
     *
     * @Route("/{idCat}/edit", name="categorie_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Categorie $categorie)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('categorie_edit', array('idCat' => $categorie->getIdcat()));
        }
     ...
     *
     * @Route("/{idCat}", name="categorie_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Categorie $categorie)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('categorie_delete', array('idCat' => $categorie->getIdcat())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
