...
class FilmController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('film_show', array('numFilm' => $film->getNumfilm()));
        }
     ...
     *
     * @Route("/{numFilm}/edit", name="film_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Film $film)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('film_edit', array('numFilm' => $film->getNumfilm()));
        }
     ...
     *
     * @Route("/{numFilm}", name="film_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Film $film)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('film_delete', array('numFilm' => $film->getNumfilm())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
